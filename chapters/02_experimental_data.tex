...
\begin{figure}
    ...
    \caption{Left: Schematic of the field cage of the TPC detector. Right: Schematic of the reconstruction mechanism for tracks in the TPC \cite{ALICE_TPC_trigger}.}
