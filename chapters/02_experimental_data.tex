...
%The combined signal extraction cuts are shown in table \ref{tab:PIDcuts}. %I decided to exclude the table since it doesnt adequately capture the signal extraction process. The TOF mass cut will be mentioned explicitly, and for more details the analysis note can be checked. 
...
\begin{figure}
    ...
    \includegraphics[width=0.48\textwidth]{figures/triton/atriton_bin_2.png}
    \includegraphics[width=0.48\textwidth]{figures/triton/triton_bin_2.png}
    \includegraphics[width=0.48\textwidth]{figures/triton/atriton_bin_3.png}
    \includegraphics[width=0.48\textwidth]{figures/triton/triton_bin_3.png}
    \includegraphics[width=0.48\textwidth]{figures/triton/atriton_bin_4.png}
    \includegraphics[width=0.48\textwidth]{figures/triton/triton_bin_4.png}
...
%For a more detailed comparison of different fitting algorithms, see section \ref{sec:App:lowStatFitting} in the appendix.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/template_fit_methods.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.32\textwidth]{figures/triton/tbar_Fit_Bin_1.pdf}
    \includegraphics[width=0.32\textwidth]{figures/triton/tbar_Fit_Bin_2.pdf}
    \includegraphics[width=0.32\textwidth]{figures/triton/tbar_Fit_Bin_3.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.47\textwidth]{figures/he3_tracking_systematics.png}
    \includegraphics[width=0.49\textwidth]{figures/triton/Systematics_tritons.png}
