...
\begin{figure}
    ...
    \caption{Extracted primary $^3\mathrm{He}$ yields in each analysis bin as a function of the value of the cut on |DCAz|.}
...
\begin{figure}
    ...
    \includegraphics[width=0.32\textwidth]{}
    \includegraphics[width=0.32\textwidth]{}
    \caption{Comparison of different methods for determining the primary fraction from the template fits. }
...
\begin{figure}
    \centering
    \includegraphics{figures/triton/Systematics_2.png}
    \caption{Evaluation of the systematic uncertainty due to track cuts. The same analysis was re-performed over 100 times with random permutations of "tight", "default", and "loose" cuts on each considered parameter.}
