...
\subsection{Constraining the propagation through the galaxy}\label{sec:Propagation}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figu}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
